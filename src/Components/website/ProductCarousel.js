...
// Skeleton loading component for individual category
function CategorySkeleton() {
  return (
    <div className="mb-5">
      <div className="d-flex justify-content-between align-items-center mb-3">
        <div className="skeleton-title" style={{ width: "200px", height: "24px" }} />
...
function CategoryCarousel({ category, settings, slugify }) {
      ...
      try {
        ...
        selectedCategories.forEach(cat => {
          initialCategories[cat.id] = {
            id: cat.id,
            name: cat.title,
            products: null, // null means loading
            loading: true
          };
        });
        ...
        // Fetch products for each category independently
